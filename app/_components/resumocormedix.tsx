        ...
        <div className="relative overflow-hidden w-full md:w-2/3 mx-0 md:mx-16">
          ...
          <div className="w-full flex flex-col justify-start items-start gap-10">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
              ...
              <p className="text-[1.2rem]">Redesign estratégico do website institucional da biofarmacêutica CorMedix <br /> para alinhar a presença digital ao lançamento de seu primeiro produto comercial, <br />o DefenCath.</p>
            </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              <div className="w-full h-px bg-[#131415]"></div>
              <p className="text-[1.2rem]">Reestruturação de +10 anos de conteúdo legado com nova arquitetura<br />  e usabilidade.</p>
              <div className="w-full h-px bg-[#131415]"></div>
