        ...
        <div className="relative overflow-hidden w-full md:w-2/3 mx-0 md:mx-16">
          ...
          <div className="w-full flex flex-col justify-start items-start gap-10">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
              ...
              <p className="text-[1.2rem] leading-7 text-[1.2rem] ">Redesenho completo da plataforma operacional legada "PD Point" da farmacêutica  MSD, para resolver problemas críticos de usabilidade e otimizar o fluxo  logístico de exames para 3 perfis de usuário distintos.</p>
            </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              <p className="text-[1.2rem] leading-7 text-[1.2rem] ">Redução de mais de 80% nos erros de preenchimento do sistema, validada através de testes e entrevistas com os usuários finais.
Criação de um Design System e documentação com com 30 telas-chave que  permitirama implementação de uma plataforma complexa de forma  consistente, ágil e escalável.</p>
