 ...
 <div className="w-full">
      ...
      <div className="max-w-[1400px] mx-auto w-full px-4 sm:px-4 md:px-8 lg:px-12 flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-1/3 bg-white relative p-12 sm:p-16 md:p-16">
          <div className="w-full flex flex-col justify-start items-start gap-4">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
              ...
              <h5 className="text-xl font-medium  text-[1.5rem]">Gerar ideias de conteúdo para o site</h5>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/3 bg-white relative p-12 sm:p-16 md:p-16">
          <div className="w-full flex flex-col justify-start items-start gap-4">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
              <h5 className="text-xl font-medium  text-[1.5rem]">Capturar a perspectiva médica.</h5>
        ...
        <div className="w-full md:w-1/3 bg-white relative p-12 sm:p-16 md:p-16">
          <div className="w-full flex flex-col justify-start items-start gap-4">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
              <h5 className="text-xl font-medium  text-[1.5rem]">Entender a jornada do paciente no SUS</h5>
      ...
      <div className="relative max-w-8xl mx-auto w-full">
        <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 z-[5] h-[620px] flex items-center justify-center">
           <img src="/bir.png" alt="" className=" object-contain"/>
        </div>
...
{/* Spline */}
      <div className="relative max-w-8xl mx-auto w-full">
        ...
        <h2>Entrevista com 1 especialista</h2>
        <div className="h-12"></div>
        <div className="flex">
