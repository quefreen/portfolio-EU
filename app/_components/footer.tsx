  ...
  return (
    <div className="w-full bg-[#131415]">
      ...
      <div className="max-w-[1400px] mx-auto w-full px-4 sm:px-4 md:px-8 lg:px-12">
        <h2 className="text-white mx-0 md:mx-16 md:text-[2rem]">
        ...
        <div className="flex flex-col md:flex-row items-start mx-0 md:mx-16 gap-4 md:gap-0">
          <p className="text-[#838383] font-semibold text-[1.5rem] mr-12 -translate-0.75" style={{ fontFamily: 'var(--font-schibstedGrotesk), sans-serif' }}>
            Chega mais, uai.
          </p>
          <a 
