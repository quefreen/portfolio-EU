...
export function HeroPD() {
  return (
    <div className="max-w-[1400px] mx-auto w-full px-4 sm:px-4 md:px-8 lg:px-12">
      ...
      <div className="mx-0 md:mx-16">
        ...
        <h1>Reanimando uma ferramenta <br /> em estado crítico.</h1>
        <div className="h-4"></div>
        <div className="inline-flex justify-start items-start gap-6">
          
  <div className="flex justify-start items-center gap-3">
    <div className="px-4 py-2 bg-white rounded-[32px] flex justify-center items-center">
      <div className="justify-start text-neutral-900 text-sm font-medium font-['Schibsted_Grotesk'] leading-5">Sistema</div>
    </div>
  </div>
  <div className="flex justify-start items-center gap-3">
    <div className="px-4 py-2 bg-white rounded-[32px] flex justify-center items-center">
      <div className="justify-start text-neutral-900 text-sm font-medium font-['Schibsted_Grotesk'] leading-5">Logistíca</div>
    </div>
  </div>
  <div className="flex justify-start items-center gap-3">
    <div className="px-4 py-2 bg-white rounded-[32px] flex justify-center items-center">
      <div className="justify-start text-neutral-900 text-sm font-medium font-['Schibsted_Grotesk'] leading-5">Exames</div>
    </div>
  </div>
</div>
  ...
  style={{
    backgroundImage: "url('/bg-msd.jpeg')", // Coloque o caminho correto da sua imagem
