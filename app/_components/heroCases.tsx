  ...
  return (
    <div className="max-w-[1280px] mx-auto w-full px-4 sm:px-8 md:px-12 lg:px-20">
      ...
      <div className="mx-0 md:mx-16">
        ...
        <h4
          className="text-[1rem] leading-[100%] text-[#a3a3a3] font-semibold"
        ...
        <h1>O redesenho estratégico da CorMedix.</h1>
        <div className="h-16"></div>
      </div>
      ...
      <div className="relative max-w-8xl mx-auto w-full">
        ...
        <div className="relative max-w-8xl h-[480px] bg-white overflow-hidden">
          <div
          ...
          <div className="flex justify-start items-start gap-8">
            <div className="inline-flex flex-col justify-start items-start gap-4">
              <div className="flex flex-col justify-start items-start gap-10">
                <div className="justify-start text-black text-base font-semibold font-['Schibsted_Grotesk'] leading-none">
                  ROLE
                </div>
              </div>
