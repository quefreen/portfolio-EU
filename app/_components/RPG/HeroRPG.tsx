...
export function HeroRPG() {
  ...
  <div className="flex justify-start items-center gap-3">
    <div className="px-4 py-2 bg-white rounded-[32px] flex justify-center items-center">
      <div className="justify-start text-neutral-900 text-sm font-medium font-['Schibsted_Grotesk'] leading-5">Dungeons & Dragons</div>
    </div>
  </div>
  <div className="flex justify-start items-center gap-3">
    <div className="px-4 py-2 bg-white rounded-[32px] flex justify-center items-center">
      <div className="justify-start text-neutral-900 text-sm font-medium font-['Schibsted_Grotesk'] leading-5">Sonorização</div>
    </div>
  </div>
</div>
        <div className="h-4"></div>
      ...
      {/* Spline */}
      <div className="relative max-w-8xl mx-auto w-full bg-white">
        <div className="absolute inset-x-0 top-1/2 -translate-y-5/9 z-[5] h-[620px] flex items-center justify-center">
           <img src="/hero-rpg.png" alt="Animate Tsuru" className=" object-contain"/>
        </div>
  ...
  style={{
    backgroundImage: "url('/')", // Coloque o caminho correto da sua imagem
