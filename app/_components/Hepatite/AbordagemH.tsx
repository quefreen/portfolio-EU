export function AbordagemH () {
  return (
    <div className="w-full">
      
      
<div className="max-w-[1400px] mx-auto w-full px-4 sm:px-4 md:px-8 lg:px-12 flex flex-col md:flex-row gap-6 items-start">
  
  <div className="w-full md:w-1/2 flex flex-col gap-y-4 mx-16">
    <div className="flex flex-col gap-y-2">
      <h4 className="text-[1rem] leading-[100%] text-[#a3a3a3] font-semibold uppercase" style={{ fontFamily: 'var(--font-schibstedGrotesk), sans-serif' }}>
        DESAFIO
      </h4>
  ...
  <div className="w-full md:w-1/2">
    <img src="/comentario.jpg" alt="" className="object-contain w-full"/>
  </div>
